User.create!([
  ...
  {admin: false, email: "user@user.com", password: "123456", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 4, current_sign_in_at: "2016-10-22 14:59:25", last_sign_in_at: "2016-10-22 00:41:38", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", credit: 2}
])
Buy.create!([
